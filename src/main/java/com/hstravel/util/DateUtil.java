...
public class DateUtil {
	...
	public static int getActualMaximumDate(int year, int month) {
		Calendar cal = getDateCalendar(year, month, 1);
		return cal.getActualMaximum(Calendar.DAY_OF_MONTH);
	}
	

	private static Calendar getDateCalendar(int year, int month, int date) {
	...
	public static String getComputedDate(int year, int month, int date,
									int type, int add) {
